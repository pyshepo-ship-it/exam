...
})
{
  ...
  // الصف جزء من عنوان الكارت بالخط نفسه + سطر تأكيد صريح (لا يخلط الطالب بين الصفوف)
  eq("اسم الصف يظهر للزائر بخط العنوان", t.includes("اختبار عام — الصف الأول الثانوي") || t.includes("الصف الأول الثانوي"))
  eq("سطر تأكيد الصف ظاهر في الكارت", t.includes("هذا الاختبار لطلاب: الصف الأول الثانوي"))
