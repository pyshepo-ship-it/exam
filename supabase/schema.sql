-- ============================================================
-- 🛡️ المخطط الأساسي للتطبيق — Supabase (حتى 017، ثم الترحيلات 018–029)
-- ============================================================
-- كيف تشغّله:
--   Supabase Dashboard → SQL Editor → New query
--   → الصق هذا الكود كاملًا → Run
--
-- ⚠️ لا تُعد تشغيل هذا الأساس منفرداً على قاعدة أحدث: سيعيد تعريف دوال
-- وصلاحيات قديمة. شغّل الترحيلات الناقصة فقط، وانظر SUPABASE_SETUP.md.
-- للمشروع الجديد: شغّل هذا الملف ثم استكمل 018–029 بالترتيب.
-- لا يحذف الملف البيانات:
