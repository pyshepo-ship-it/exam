...
> **ما يفعله الملف:** ينشئ كل الجداول الـ14 والفهارس وعملية RLS وسياسات الأمان كاملة —
> الصفوف، المجموعات، الطلاب، الاستحقاقات، المدفوعات، الاختبارات، الحصص، الحضور،
> الإعلانات، لوحة الشرف، الملفات، الروابط، أرشيف السنوات، والإعدادات — مع سياسات
> تسمح للمدير (الحساب المصادق) بالوصول الكامل، ولأي زائر بالقراءة فقط من جداول
...
> - ملف واحد يكفي: يدمج كل النسخ السابقة (002 و 003)

**كيف يعمل التخزين:**
- Supabase هو **المصدر الحقيقي** لبياناتك: كل حفظ في النظام يُرفع تلقائياً، وكل فتح للوحة التحكم يجلب أحدث البيانات.
- بياناتك الموجودة حالياً في متصفحك **تُرفع تلقائياً مرة واحدة** عند أول دخول بعد تشغيل المخطط (سيظهر إشعار بذلك).
- **الصفحة الرئيسية** (الإعلانات، لوحة الشرف، الملفات، الروابط) تُقرأ مباشرة من Supabase فتظهر **للطلاب من أي جهاز** بدون تسجيل دخول.
- يعمل النظام أيضاً بدون Supabase (وضع محلي تجريبي) لكن البيانات في هذه الحالة تبقى في المتصفح فقط.
